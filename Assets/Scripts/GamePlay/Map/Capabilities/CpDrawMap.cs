...
namespace GamePlay.Map
{
    ...
    public partial class CpDrawMap : CapabilityBase
    {
        ...
        {
            context.QuerySnapshotByIds(m_Entities, m_GridId, m_DrawMapId, m_NationIndexId,
                m_TerritoryPaintStateId);
        ...
        private void TickOne(CapabilityContext context, CEntity entity)
        {
            ...
            if (!entity.TryGetDrawMap(out var drawMap)) return;
