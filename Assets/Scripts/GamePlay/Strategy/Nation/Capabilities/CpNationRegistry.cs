...
namespace GamePlay.Strategy
{
    ...
    public class CpNationRegistry : CapabilityBase
    {
        ...
        {
            context.QuerySnapshotByIds(m_Entities, m_NationBootstrapId, m_NationIndexId);
        ...
        private void RegisterOne(CapabilityContext context, CEntity entity)
        {
            ...
            context.Commands.RemoveComponent(entity, m_NationBootstrapId);
        }
        ...
        private void RegisterTemplates(GameWorld gameWorld, NationIndex nationIndex)
        {
            ...
            foreach (var pair in templates)
            {
                ...
                {
                    Debug.LogWarning(
                        "[CpNationRegistry] Nation capacity exceeded; extra templates were ignored.");
                    return;
                }
