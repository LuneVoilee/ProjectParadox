...
namespace GamePlay.Strategy
{
    ...
    public class PathPresentationCap : CapabilityBase
    {
            ...
            (CapabilityContext context, float deltaTime, float realElapsedSeconds)
        {
            ...
            EntityGroup group = context.Query<UnitPosition, UnitMotor, UnitMoveTarget>();
            ...
            {
                SyncOne(entity, grid, drawMap.Tilemap);
            }
        }
        ...
        public override void Dispose()
        {
            ...
            EntityGroup group = World.GetGroup(EntityMatcher.SetAll(
                Component<UnitMoveTarget>.TId));
            if (group?.EntitiesMap != null)
            {
                foreach (CEntity entity in group.EntitiesMap)
                {
        ...
        private void SyncOne(CEntity entity, Grid grid, Tilemap tilemap)
        {
